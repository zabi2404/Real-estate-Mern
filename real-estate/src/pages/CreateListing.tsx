...
export default function CreateListing() {
    ...
    const HandleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
        ...
        if (e.target.name === "bathroom" || e.target.name === "bedroom") {
            setformData({
                ...formData,
        ...
        try {
            ...
            for (let i = 0; i < files.length; i++) {
                ...
                if (!cloudinaryUploadUrl) {
                    throw new Error("VITE_CLOUDINARY_UPLOAD_URL is not configured");
                }
    ...
    return (
        <>
            <div>
                <div className="mt-8"><h1 className="font-black text-2xl text-center">Create a Listing</h1></div>
                ...
                ">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex items-center ">
                            ...
                            }} type="button" className=" ml-3 uppercase border cursor-pointer border-green-700 text-green-700 p-3 rounded-[2px]">
                                upload
                            </button>
                        </div>
                        {progress > 0 && (
                        ...
                        {file && (
                            <div className=" ">
                                {file.map((item,index) => (
                                    <div className="flex w-[460px] gap-2 items-center border rounded-[6px] border-gray-500 p-2 my-2">
                                        <img
                                        key={index}
